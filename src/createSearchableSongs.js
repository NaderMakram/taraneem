...
const songsDB = JSON.parse(fs.readFileSync(path.join(__dirname, "taraneemDB.json"), "utf-8"));
...
try {
    fs.writeFileSync(path.join(__dirname, '../src/searchableSongsDB.json'), JSON.stringify(songsWithSearchableContent, null, 2));
    console.log('Search data successfully prepared and saved to searchableSongsDB.json');
} catch (error) {
